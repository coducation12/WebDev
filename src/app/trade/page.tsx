            ...
            {(() => {
              const pillars = [
                ...
                },
                {
                  ...
                  desc: "우리의 책임감은 산업의 기반이 되는 원재료와 자원 무역에서도 이어집니다. 친환경·고효율 산업재와 친환경 제조 연계, 자원 수입 및 다각적인 연계무역을 통해 산업 현장에 안정적이고 지속 가능한 공급망을 제공합니다. 환경에 미치는 영향을 최소화하는 자원 순환형 비즈니스로 산업의 미래를 함께 다집니다.",
                },
                {
                  num: "03",
